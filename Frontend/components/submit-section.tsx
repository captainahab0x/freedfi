      ...
      <div className="flex justify-center space-x-4">
        <div className="rounded-lg p-6 w-96">
          <div>
            ...
            <div className="text-5xl font-bold text-purple-500 mb-4 text-center md:text-center">
              75%
            </div>
            ...
            <p className="text-sm italic mt-8">
              Your limit is determined by work, contract and escrows
            </p>
          </div>
        </div>
        <div className="rounded-lg p-6 w-96 justify-center items-center">
          <div className="px-8">
            <p className="mt-8 mb-4 font-semibold text-center md:text-left">
